...
order_E11_farmers_melt <- E11_farmers_melt[order(id),]
...
new_reg1 = rep(reg_indicators[,1])
new_reg9 = rep(reg_indicators[,9])
new_whole1 = rep(whole_data[,1])
...
new_reg_ind11_wealth = reg_ind11_wealth[c(-24,-30,-67),]
